        ...
        <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 bg-[url('/images/hero_bg.png')] bg-cover bg-center">
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-slab font-bold text-white uppercase tracking-tight">Login RocketsRollers</h1>
                </div>
                ...
                <SignIn
                    appearance={{
                        elements: {
                            rootBox: "mx-auto",
                            card: "bg-zinc-900/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl overflow-hidden",
                            headerTitle: "hidden",
