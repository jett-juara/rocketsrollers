        ...
        <div className="max-w-[1200px]">
            <div className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-zinc-500 font-heading font-black uppercase tracking-[0.4em] text-[10px]">Partner Network</span>
                </div>
                <h1 className="text-6xl font-heading font-black uppercase tracking-tighter italic leading-none">
                    Partners & <span className="text-zinc-500">Sponsors</span>
                </h1>
            </div>
            ...
            >
                ...
                <p className="text-zinc-500 font-body text-sm max-w-md mx-auto">
                    Fitur manajemen partner dan sponsor sedang dalam tahap pengembangan. Kamu akan bisa mengelola logo, link, dan tier sponsor dari sini.
                </p>
            </motion.div>
        </div>
    );
